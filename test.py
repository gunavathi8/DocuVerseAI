...
# PDF_PATH = r"G:\Krish_Naik_LLMOps_Course\Projects\document_portal\data\document_analysis\sample.pdf"
...
# This is to test document compare agent
# import io
# from pathlib import Path
# from src.document_compare.data_ingestion import DocumentIngestion
# from src.document_compare.doc_comparer import DocumentCompareAgent

# def load_fake_uplaoded_files(file_path:Path):
#     return io.BytesIO(file_path.read_bytes())

# def test_compare_docs():
#     ref_path = Path("G:\Krish_Naik_LLMOps_Course\Projects\document_portal\data\data_compare\Long_Report_V2.pdf")
#     act_path = Path("G:\Krish_Naik_LLMOps_Course\Projects\document_portal\data\data_compare\Long_Report_V1.pdf")
...
#     llm_comparator = DocumentCompareAgent()
...
#     pdf_path = r"G:\Krish_Naik_LLMOps_Course\Projects\document_portal\data\single_document_chat\NIPS-2017-attention-is-all-you-need-Paper.pdf"
#     question = "What is the significance of attention mechanism? Can you explain?"
...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            r"data/multi_document_chat/market_analysis_report.docx",
            r"data/multi_document_chat/NIPS-2017-attention-is-all-you-need-Paper.pdf",
            r"data/multi_document_chat/sample.pdf",
            r"data/multi_document_chat/state_of_the_union.txt"
        ]
        ...
        question = "explain briefly what transformer is "
